$(document).ready(function() {
    ...
    $('#addParcela').live('click', function() {
        $('<p><label>Parcela:</label><input type="text" size="1" value="' + i +  '" disabled/><input type="text" size="9" id="data'+i+'"class="money" placeholder="Parcela" name="parcela[]" /><input type="text" name="data[]" size="10" placeholder="Data" /></p>').appendTo(d);
